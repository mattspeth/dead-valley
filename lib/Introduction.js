define(['Game', 'GameTime', 'Vector', 'hud/Hud', 'fx/Hint'], function (Game, GameTime, Vector, Hud, Hint) {
  ...
  var Hints = {
    ...
    skip: {
      windowPos:    Vector.create(64, 655, true),
      text:         "Disable Hints",
      tail:         false,
      id:           'skip-hints',
      fadeDuration: 0.5,
    ...
    buildingInventory: {
      windowPos: Vector.create(305, 265, true),
      duration:  10   ,
    ...
    dragPistol: {
      windowPos: Vector.create(1075, 155, true),
      duration:  10,
    ...
    enterPickup: {
      pos:      Vector.create(centerX, 300, true),
      duration:  10,
    ...
    enterHouse: {
      pos:      Vector.create(centerX, 115, true),
      duration:  10,
      text:     "Press E to Enter!",
      tail:     'bottom',
      throb:    true
    ...
    showCarInventory: {
      windowPos: Vector.create(centerX, 150, true),
      duration:  10,
      text:      "Bring up the truck's inventory by pressing I.",
      tail:      false
    },
    truckInventory: {
      windowPos: Vector.create(155, 265, true),
      duration:  10,
      text:      "This is the Truck's Inventory.",
      tail:      'bottom'
    },
    fuelGauge: {
      windowPos: Vector.create(325, 160, true),
      duration:  10,
